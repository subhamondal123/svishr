...
// this is mentor story component
class MentorStory extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    _onStoryTextChange = (value) => {
        ...
        this.props.storyChangeText(this.state.allData.storyText);
    }
    // this is input focus function 
    focusedInput = () => {
            ...
            <SafeAreaView style={styles.container}>
                ...
                <ScrollView showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false}>
                    <View style={{ marginHorizontal: '10%', }}>
                        <View style={[styles.inputSec, { backgroundColor: this.state.isActive ? "#C6EFED" : "#E3F9F8", borderWidth: this.state.isActive ? 0.5 : 0, }]}>
...
export default connect(mapStateToProps, mapDispatchToProps)(MentorStory);
