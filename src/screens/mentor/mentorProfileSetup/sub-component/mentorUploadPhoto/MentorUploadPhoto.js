...
// this is mentor upload photo component 
                            ...
                            <View style={{ flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center' }}>
                                {
                                    this.state.avaterData.map((item, index) => (
                                        <TouchableOpacity key={index} style={{ backgroundColor: '#E3F9F8', borderRadius: 200, height: 90, width: 90, alignItems: 'center', justifyContent: 'center', marginRight: 10, marginTop: 10 }} onPress={() => this._onAvatarUpload(item)} activeOpacity={0.7}>
                                            <Image source={{ uri: App_uri.IMAGE_VIEW_URI + item.others }} style={{ height: 90, width: 90, resizeMode: 'contain', borderRadius: 200 }} />
                                        </TouchableOpacity>
