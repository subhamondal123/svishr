...
// this is hobbies and interests component
class MentorHobbiesAndInterests extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    // this is the function which is select hobbies 
    onSelect = (item, index) => {
    ...
    // this is the delete function for selected hobbies items 
    _onDelete = (index) => {
        let dataHobbiesArr = this.state.allData.hobbiesInterestsArr;
            ...
            <SafeAreaView style={styles.container}>
                <View style={{ marginHorizontal: '10%', marginTop: '5%' }}>
                    ...
                    <View style={styles.scrollSec}>
                        <ScrollView>
                            <View style={styles.scrollViewSec}>
                                {this.state.allData.hobbiesInterestsArr.map((item, index) => (
                                    <TouchableOpacity key={index} onPress={() => this.onSelect(item, index)} activeOpacity={0.7}>
                                        <View style={{
                                            ...
                                            borderColor: '#008080',
                                            backgroundColor: item.check ? "#2f807f" : Color.COLOR.WHITE.PURE_WHITE,
                                            marginHorizontal: 5,
                                            marginVertical: 5,
                                            flexDirection: 'row',
                                            alignItems: 'center'
                    ...
                    <TextComponent text={this.state.allData.hobbiesError} additionalStyles={styles.errorMsgSec} props={this.props} />
...
export default connect(mapStateToProps, mapDispatchToProps)(MentorHobbiesAndInterests);
