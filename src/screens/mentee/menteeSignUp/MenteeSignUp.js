...
class MenteeSignUp extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            emailText: "",
    ...
    // this is the function which is call mentee signUp api 
    _onSignUp = async () => {
        ...
        if (errorCount === 0) {
            ...
            if (responseDta) {
                if (responseDta.respondcode === ErrorCode.ERROR.ERROR_CODE.SUCCESS) {
                    ...
                    this.props.navigation.navigate("OtpVerification", { email: this.state.emailText, otpType: "signUp", userTypeId: this.state.userTypeId, userData: "Mentee" })
    ...
    // this is the function which is navigate to login page 
    _onLogin = (type) => {
        this.props.navigation.push("LoginPage", { loginType: "Mentee" })
    }
                ...
                <SafeAreaView style={styles.container}>
                    ...
                    <ScrollView showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false}>
                        <View style={{ marginHorizontal: '6%', }}>
                            <TextComponent text={"Create Mentee Account"} additionalStyles={styles.titleText} props={this.props} />
                            {this.emailSec()}
                            {this.passwordSec()}
                            ...
                            <View style={styles.googleSIgnInSec}>
                                <Image source={ImageName.GOOGLE} style={styles.imgStyle} />
                                <View style={{ flex: 0.1 }} />
                                <Image source={ImageName.LINKEDIN_IMAGE} style={styles.imgStyle} />
                                <View style={{ flex: 0.1 }} />
                                <Image source={ImageName.FACEBOOK_IMAGE} style={styles.imgStyle} />
                            </View>
                        ...
                        <View style={styles.menteeImgSec}>
                            <Image source={ImageName.MENTEE_LOGIN_IMAGE} style={{ height: 300, resizeMode: 'contain' }} />
                        </View>
                    </ScrollView>
                </SafeAreaView>
            </KeyboardAvoidingView>
...
export default connect(mapStateToProps, mapDispatchToProps)(MenteeSignUp);
