...
// this is mentee bit component 
class MenteeBit extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  // this is phone number onChange function 
  ...
  // this function used for focus input section 
  nameInputFocus = () => {
  ...
  // this function used for focus phone no input section 
  phoneInputFocus = () => {
...
export default connect(mapStateToProps, mapDispatchToProps)(MenteeBit);
